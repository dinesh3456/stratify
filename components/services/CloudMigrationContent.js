...
// Stripe Flip Card Component (for Cloud Migration Capabilities)
...
const CloudMigrationContent = () => {
  ...
  const capabilities = [
    {
      ...
      description:
        "Evaluate infrastructure readiness and create tailored migration roadmaps",
      details: [
  ...
  return (
    <div className="services-details__content position-relative overflow-hidden px-3">
      ...
      {/* Enhanced Cloud Migration Capabilities Section with Stripe Flip Animation */}
      <div
      ...
      {/* Cloud Migration Success Stories Section - Using AI Capability Card Style */}
