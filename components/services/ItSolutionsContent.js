...
// Import the IT Capability Icons
import {
  CybersecurityIcon,
  ...
  const capabilities = [
    {
      ...
      description: "Advanced threat detection and security compliance",
      details: [
    ...
    {
      id: 2,
      icon: NetworkInfrastructureIcon,
      title: "Network Infrastructure & Management",
      description: "Network design, optimization and monitoring",
      details: [
    ...
    },
    {
      ...
      description: "Round-the-clock help desk and system monitoring",
      details: [
    ...
    },
    {
      ...
      description: "Legacy system modernization and API integration",
      details: [
  ...
  const successStories = [
    {
      ...
      subtitle: "Fortune 500 company infrastructure modernization",
      frontIcon: (
        <div>
          <svg
            width="60"
      ...
      backContent: {
        ...
        features: [
          "Migrated 500+ workstations to modern platform",
    ...
    },
    {
      ...
      subtitle: "HIPAA-compliant security implementation",
      frontIcon: (
        <div>
          <svg
            width="60"
      ...
      backContent: {
        title: "Secure Healthcare IT Infrastructure",
        features: [
    ...
    {
      id: 3,
      title: "Manufacturing Network Upgrade",
      subtitle: "Industrial IoT and network modernization",
      frontIcon: (
        <div>
          <svg
            width="60"
      ...
      backContent: {
        ...
        features: [
          "Industrial IoT network implementation",
  ...
  return (
    <div className="services-details__content position-relative overflow-hidden px-3">
      ...
      <p>
        ...
        focusing on growth and customer acquisition.
      </p>
      <p>
        ...
        security posture while reducing costs.
      </p>
      ...
      {/* Enhanced IT Service Capabilities Section with Standard Flip Animation (rotateY) */}
      <div
      ...
      <div className="content mt-5">
        <div className="text">
          <h3>IT Implementation Process</h3>
          <p>
            Our proven methodology ensures seamless technology implementation
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 column">
                <div className="process-card p-4 border rounded">
                  ...
                  <p>
                    ...
                    change management, team training, and 24/7 ongoing support.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* IT Success Stories Section - Using Stripe Flip Animation (rotateX) */}
      <div
        className="ai-capabilities-container mt-5 p-4 position-relative"
        style={{
          background:
      ...
      <div className="ai-cta-section mt-5 p-5 rounded text-center">
        ...
        <div className="position-relative ai-cta-content">
          ...
          <div className="cta-buttons">
            ...
            >
              <span className="ai-cta-button-text">Get IT Consultation</span>
