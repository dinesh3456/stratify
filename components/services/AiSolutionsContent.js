...
const AiSolutionsContent = () => {
  return (
    <div className="services-details__content position-relative overflow-hidden px-3">
      ...
      {/* Step 4: Updated AI Capabilities in 3-column grid */}
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="capability-card h-100 p-4 border rounded bg-light">
              ...
              <h5 className="capability-title">Agentic AI Solutions</h5>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="capability-card h-100 p-4 border rounded bg-light">
              ...
              <h5 className="capability-title">Intelligent Automation & RPA</h5>
              <ul className="list-unstyled mt-3">
                <li className="mb-2">
                  <i
                    className="fas fa-check-circle me-2"
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 column">
              <div className="process-card p-4 border rounded">
                <img
                  ...
                  src="/assets/images/aiservice/ai-strategy-assessment.jpg"
                  alt="AI Strategy Assessment"
                  style={{ height: "200px", objectFit: "cover" }}
                />
                <h5 className="mb-3">Strategic AI Assessment</h5>
                <p>
                  Strategic AI assessment and roadmap development tailored to
                  your business objectives and technical requirements.
                </p>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-12 column">
              <div className="process-card p-4 border rounded">
                <img
                  className="mb-3 w-100 rounded"
                  src="/assets/images/aiservice/ai-model-deployment.jpg"
                  alt="AI Model Deployment"
                  style={{ height: "200px", objectFit: "cover" }}
                />
                <h5 className="mb-3">End-to-End AI Development</h5>
                <p>
      ...
      <div className="ai-tech-stack mt-5">
        <h3 className="mb-4">Our AI Technology Stack</h3>
      ...
      <div className="ai-use-cases mt-5">
        <h3 className="mb-4">AI Solutions in Action</h3>
        <div className="row">
          {/* Healthcare AI Solutions - using Health and Life Sciences design */}
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="service-three__item ai-use-case-card text-center h-100">
              ...
              <h4 className="mb-2 text-center ps-1">Healthcare AI Solutions</h4>
              <p className="small text-muted mt-2">
                Intelligent diagnostic systems and patient care optimization
              </p>
            </div>
          </div>

          {/* Financial AI Applications - using Financial Consulting design */}
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="service-three__item ai-use-case-card text-center h-100">
              <div className="icon mb-3">
                <svg
              ...
              <h4 className="mb-2 text-center ps-1">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="service-three__item ai-use-case-card text-center h-100">
              ...
              <p className="small text-muted mt-2">
                Intelligent production optimization and maintenance
              </p>
            </div>
          </div>
        </div>
