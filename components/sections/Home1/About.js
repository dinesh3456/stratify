          ...
          <div className="row g-0">
            <div className="col-lg-4">
              <div className="about__item about__content">
                ...
                <ul>
                  {[
                    "Advanced AI-driven solutions for strategic growth",
                    "Scalable cloud infrastructure & data analytics",
                    "End-to-end software product engineering",
                    "Smart automation for operational excellence",
                  ].map((item, index) => (
                    <li key={index}>
                      <svg
                        width="16"
              ...
              <div className="about__item about__testimonial">
                <div>
                  ...
                  <p>
                    ...
                    in software solutions. Their cutting-edge technology
                    approach transforms our business operations and drives
                    sustainable growth. From ideation to deployment, they
                    delivered exceptional results.
                  </p>
                </div>
                <h4 className="title">
                  TechVision Corp. <span>USA</span>
                </h4>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="about__item about__funfact">
                ...
                <div>
                  ...
                  <p className="text">Innovation Partners Worldwide</p>
                </div>
              </div>
            </div>
          </div>
